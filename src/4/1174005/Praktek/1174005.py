...
with open('teori2.csv', mode='w') as csv_file:
    ...
    csv_writer.writerow(['1174002', 'Engelberth', 'D4TI2C'])
    csv_writer.writerow(['1174003', 'Ridho Mali', 'D4TI2B'])
...
with open('teori3.csv', mode='w') as csv_file:
    ...
    writer.writeheader()
    writer.writerow({'npm': '1174009', 'nama': 'Ridho Mali', 'kelas': 'D4TI2A'})
    writer.writerow({'npm': '1174010', 'nama': 'Riski', 'kelas': 'D4TI2A'})
